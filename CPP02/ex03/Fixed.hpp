...
public:
    ...
    // A friend function is not a member of the class, but it has access to private members.
    // friend allows operator<< to work with std::cout while still accessing private data. With friend, the operator<< is allowed to access _rawBits and call toFloat().
